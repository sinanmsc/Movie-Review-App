...
class BtmNavigation extends ConsumerWidget {
  const BtmNavigation({
    super.key,
  });
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return MoltenBottomNavigationBarNew(
      barColor: Colors.transparent,
      tabs: [
        MoltenTab(icon: Icon(Icons.home)),
        MoltenTab(icon: Icon(Icons.video_library_outlined))
      ],
      selectedIndex: ref.watch(btmProvider),
      onTabChange: (index) {
...
class MoltenBottomNavigationBarNew extends StatelessWidget {
...
class _MoltenTabWrapper extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return IconTheme(
      data: IconThemeData(
        color: isSelected
            ? tab.selectedColor ?? Colors.red
            : tab.unselectedColor ?? Colors.white,
      ),
      child: Container(
        height: circleSize,
        width: circleSize,
