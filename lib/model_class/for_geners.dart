...
//
//     final forGeners = forGenersFromJson(jsonString);

import 'dart:convert';

ForGeners forGenersFromJson(String str) => ForGeners.fromJson(json.decode(str));

String forGenersToJson(ForGeners data) => json.encode(data.toJson());
...
class ForGeners {
    ...
    factory ForGeners.fromJson(Map<String, dynamic> json) => ForGeners(
        adult: json["adult"],
